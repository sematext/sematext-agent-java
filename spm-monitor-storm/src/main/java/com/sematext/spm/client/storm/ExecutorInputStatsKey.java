...
public class ExecutorInputStatsKey {
  private String executorId;
  private String componentId;
  private String inputComponentId;
  private String stream;

  public ExecutorInputStatsKey(String executorId, String componentId, String inputComponentId, String stream) {
  ...
  public void setInputComponentId(String inputComponentId) {
    this.inputComponentId = inputComponentId;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExecutorInputStatsKey that = (ExecutorInputStatsKey) o;
    ...
    if (inputComponentId != null ? !inputComponentId.equals(that.inputComponentId) : that.inputComponentId != null)
      return false;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (inputComponentId != null ? inputComponentId.hashCode() : 0);
    result = 31 * result + (stream != null ? stream.hashCode() : 0);
    return result;
  }

  public String toKey() {
    return StringUtils.join(Arrays.asList(executorId, componentId, stream, inputComponentId), ":");
  }
