...
public class SimpleLogger extends DefaultLogger {

  public SimpleLogger(Map<String, Object> params, LogLine.Key... possibleLogLineKeys) {
    super(params, possibleLogLineKeys);
  }
