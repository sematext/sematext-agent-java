...
/**
 * Our custom version of FileChannel which will (indirectly) create daemon threads instead of non-deamon which is
 * done by Flume (this is then causing issues with JVM shutdown in javaagent setups).
 */
@InterfaceAudience.Private
@InterfaceStability.Stable
@Disposable
public class DaemonFileChannel extends BasicChannelSemantics {

  private static final Logger LOG = LoggerFactory
      .getLogger(DaemonFileChannel.class);
  ...
  private DaemonFlumeChannelLog log;
  ...
  public synchronized void start() {
    ...
    try {
      DaemonFlumeChannelLog.Builder builder = new DaemonFlumeChannelLog.Builder();
  ...
  static class FileBackedTransaction extends BasicTransactionSemantics {
    ...
    public FileBackedTransaction(DaemonFlumeChannelLog log, long transactionID,
