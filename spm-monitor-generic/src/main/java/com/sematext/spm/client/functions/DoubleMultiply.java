 ...
 * e.g. func:DoubleMultiply(request.avg.latency,request.count)
 */
public class DoubleMultiply implements CalculationFunction {
  private static final Log LOG = LogFactory.getLog(DoubleMultiply.class);
