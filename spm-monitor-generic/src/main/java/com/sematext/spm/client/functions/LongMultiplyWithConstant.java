 ...
 */
public class LongMultiplyWithConstant implements CalculationFunction {
  private static final Log LOG = LogFactory.getLog(LongMultiplyWithConstant.class);
  ...
  @Override public Object calculateAttribute(Map<String, Object> metrics, Object... params) {
    if (params != null && params.length == 2) {
      ...
      if (metricValue != null) {
        return (long) (((Number) metricValue).doubleValue() * multiplicationFactor);
      } else {
