...
/**
 * Divides the values of metrics by each other, starting from the left to right.
 * e.g. func:DoubleDivide(request.time,request.count)
 */
public class DoubleDivide implements CalculationFunction {
  private static final Log LOG = LogFactory.getLog(DoubleDivide.class);
