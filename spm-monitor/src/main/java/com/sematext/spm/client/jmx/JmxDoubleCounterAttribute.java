...
/**
 * Represents simple counter attribute
 */
public class JmxDoubleCounterAttribute extends MBeanAttributeObservation {
  public JmxDoubleCounterAttribute() {
  }

  public JmxDoubleCounterAttribute(MBeanAttributeObservation original, String newAttributeName) {
  ...
  public MBeanAttributeObservation getCopy(String newAttributeName) {
    return new JmxDoubleCounterAttribute(this, newAttributeName);
  }
}
