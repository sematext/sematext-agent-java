...
/**
 * Represents gauge attribute. Such attributes don't track the delta between two time points, but absolute cummulative
 * value at each point.
 */
@Deprecated
public class JmxGaugeAttribute extends MBeanAttributeObservation {
  public JmxGaugeAttribute() {
  }

  public JmxGaugeAttribute(MBeanAttributeObservation original, String newAttributeName) {
  ...
  public MBeanAttributeObservation getCopy(String newAttributeName) {
    return new JmxGaugeAttribute(this, newAttributeName);
  }
}
