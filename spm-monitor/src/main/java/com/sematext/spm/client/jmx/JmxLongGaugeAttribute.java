...
public class JmxLongGaugeAttribute extends MBeanAttributeObservation {
  public JmxLongGaugeAttribute() {
  }

  public JmxLongGaugeAttribute(MBeanAttributeObservation original, String newAttributeName) {
  ...
  public MBeanAttributeObservation getCopy(String newAttributeName) {
    return new JmxLongGaugeAttribute(this, newAttributeName);
  }
}
