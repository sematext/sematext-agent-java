...
public class JmxDoubleGaugeAttribute extends MBeanAttributeObservation {
  public JmxDoubleGaugeAttribute() {
  }

  public JmxDoubleGaugeAttribute(MBeanAttributeObservation original, String newAttributeName) {
  ...
  public MBeanAttributeObservation getCopy(String newAttributeName) {
    return new JmxDoubleGaugeAttribute(this, newAttributeName);
  }
}
