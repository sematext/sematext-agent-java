 ...
 */
public class JmxRealCounterAttribute extends MBeanAttributeObservation {
  public JmxRealCounterAttribute() {
  }

  public JmxRealCounterAttribute(MBeanAttributeObservation original, String newAttributeName) {
  ...
  public MBeanAttributeObservation getCopy(String newAttributeName) {
    return new JmxRealCounterAttribute(this, newAttributeName);
  }
}
