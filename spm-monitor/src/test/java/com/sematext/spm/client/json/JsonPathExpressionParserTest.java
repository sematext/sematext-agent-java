...
public class JsonPathExpressionParserTest {
  //@Test
  public void testParseNodes_old() {
    ...
    nodes = JsonPathExpressionParser.parseNodes("$.upstreams.someNode[?(@.responses.x=${xva[lue} && @.responses.y=1]1)].responses");
    Assert.assertEquals(4, nodes.length);
  }

  // @Test
  public void testParseNodes_brackets_old() {
    String[] nodes = JsonPathExpressionParser.parseNodes("$[nodes][${nodeId}][jvm][gc][collectors][${gcName}]");
