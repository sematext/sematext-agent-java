...
public final class Configuration {
  ...
  private final String defaultTagAliasesEndpoint = SenderUtil.DEFAULT_SAAS_PROD_RECEIVER_TAG_ALIASES_ENDPOINT;
  ...
  public String getDefaultTagAliasesEndpoint() {
    return defaultTagAliasesEndpoint;
  }
