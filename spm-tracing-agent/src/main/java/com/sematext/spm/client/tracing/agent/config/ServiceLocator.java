...
public class ServiceLocator {
  ...
  public static Sampler<String> getTransactionSampler() {
    return CONFIGURER.getTransactionSampler();
  }

  public static Sampler<TracingError> getTracingErrorSampler() {
    return CONFIGURER.getTracingErrorSampler();
  }

  public static List<Sink<PartialTransaction>> getTransactionSinks() {
    return CONFIGURER.getTransactionSinks();
  }

  public static List<Sink<TracingError>> getErrorSinks() {
