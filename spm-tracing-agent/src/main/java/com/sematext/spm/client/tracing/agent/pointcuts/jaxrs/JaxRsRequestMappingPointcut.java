 ...
 * under the License.
 */
package com.sematext.spm.client.tracing.agent.pointcuts.jaxrs;
...
@LoggerPointcuts(name = "logger:jax-rs-request-mapping-logger", methodAnnotations = {
    "javax.ws.rs.GET",
    "javax.ws.rs.PUT",
    "javax.ws.rs.POST",
    "javax.ws.rs.HEAD",
...
public class JaxRsRequestMappingPointcut implements UnloggableLogger {
  @Override
