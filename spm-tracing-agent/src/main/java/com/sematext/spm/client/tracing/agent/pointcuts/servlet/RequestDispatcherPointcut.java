...
@LoggerPointcuts(name = "request-dispatcher:logger", methods = {
    "void javax.servlet.RequestDispatcher#forward(javax.servlet.ServletRequest req, javax.servlet.ServletResponse resp)",
    "void javax.servlet.RequestDispatcher#include(javax.servlet.ServletRequest req, javax.servlet.ServletResponse resp)"
})
public class RequestDispatcherPointcut implements UnloggableLogger {
  @Override
  public void logBefore(LoggerContext context) {
    Tracing.current().newCall(context.getJoinPoint());
    Tracing.current().setTag(Call.CallTag.JSP);
  }
