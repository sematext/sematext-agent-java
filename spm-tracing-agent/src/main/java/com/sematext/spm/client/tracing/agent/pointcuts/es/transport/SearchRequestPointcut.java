...
@LoggerPointcuts(name = "es-transport:search-request-pointcut", methods = {
    "org.elasticsearch.action.search.SearchRequest org.elasticsearch.action.search.SearchRequest#source(org.elasticsearch.search.builder.SearchSourceBuilder builder)"
})
public class SearchRequestPointcut implements UnloggableLogger {
  @Override
  public void logBefore(LoggerContext context) {
    ((SpmSearchRequestAccess) context.getThat())._$spm_tracing$_setSearchRequestBuilder(context.getAllParams()[0]);
  }
