...
@LoggerPointcuts(name = "jdbc:connection-logger", methods = {
    ...
    "java.sql.Statement java.sql.Connection#createStatement(int type, int concurrency)",
    "java.sql.Statement java.sql.Connection#createStatement(int type, int concurrency, int holdability)"
}, ignorePatterns = JDBCPointcut.PROXY_PATTERN)
public class JDBCConnectionCreateStatementPointcut implements UnloggableLogger {
  @Override
