 ...
 * under the License.
 */
package com.sematext.spm.client.tracing.agent.pointcuts.spring;
...
@LoggerPointcuts(name = "logger:spring-request-mapping-logger", methodAnnotations = {
    "org.springframework.web.bind.annotation.RequestMapping"
})
public class SpringRequestMappingPointcut implements UnloggableLogger {
  @Override
