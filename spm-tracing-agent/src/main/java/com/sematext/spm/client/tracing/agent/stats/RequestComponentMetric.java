...
public class RequestComponentMetric extends Statistics.Metric<RequestComponentStatistics.RequestComponent> {
  private final DiffCounterVar<Long> countVar;
  private final DiffCounterVar<Long> durationVar;

  public RequestComponentMetric(RequestComponentStatistics.RequestComponent requestComponent,
                                MutableVarProvider varProvider) {
    super(requestComponent);
  ...
  protected void update(PartialTransaction transaction, Call call) {
    ...
    durationVar.increment(call.getSelfDuration());
  }
}
