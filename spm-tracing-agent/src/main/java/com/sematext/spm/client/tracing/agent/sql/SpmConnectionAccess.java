...
public interface SpmConnectionAccess {
  @Getter("_$spm_tracing$_url")
  String _$spm_tracing$_url_get();

  @Setter("_$spm_tracing$_url")
  void _$spm_tracing$_url_set(String url);
}
